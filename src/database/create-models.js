...
const commands = [
  ...
  'npx sequelize-cli model:generate --name Seguimiento --attributes nombre:string,motivo:string,deleted:boolean --force',
  'npx sequelize-cli model:generate --name Entrevista --attributes nombre:string,observaciones:string,acciones:string,deleted:boolean --force',
  'npx sequelize-cli model:generate --name Persona --attributes nombre:string,apellido:string,email:string,password:string,id_documento:integer,documento:string,telefono:string,id_genero:integer,id_localidad:integer,id_provincia:integer,id_pais:integer,id_carrera:integer,deleted:boolean --force',
  ...
  'npx sequelize-cli model:generate --name Storage --attributes nombre:string,url:string,deleted:boolean --force',
];
